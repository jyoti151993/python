...
def my_squared (first_num):
    return first_num**2

def firstnum_raised_secondnum(first_num, second_num):
    return first_num**second_num
...
Name= 'gaurav' 
existing_salary = 900
def incremented_sal(existing_salary,Name,raised_salary_percentage):
    return "Existing Salary of"+Name+"is"+str(existing_salary)+"his incremented salary is"+(existing_salary*raise_salary_percentage/100)
...
def journey_fare(source,destination,fare,discount_rate):
